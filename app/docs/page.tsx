                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1.5">
                        ...
                        {!isLearning && item.pricing && (
                          <span className={`text-[10px] font-mono border px-1.5 py-0.5 rounded-sm uppercase tracking-wide ${pricingLabel[item.pricing.type].className}`}>
                            {pricingLabel[item.pricing.type].label}
                          </span>
                        )}
                      </div>
